...
from tinygrad.runtime.support.tinytpu_isa import ROWS as _ROWS, COLS as _COLS, TILE_ELEMS as _TILE_ELEMS, NUM_VREGS as _NUM_VREGS, VPU_OPS as _VPU

# ---------------------------------------------------------------------------
# Tile geometry and opcode tables
# ---------------------------------------------------------------------------
